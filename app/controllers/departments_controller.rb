class DepartmentsController < ApplicationController
  ...
  private
    ...
    def department_params
      params.require(:department).permit(:user_id, :name, :manager, :via, :civico, :cap, :citta, :provincia, :latitude, :longitude, :dep_map, :dep_event, :description, :floors, :number_of_spaces)
    end
end
