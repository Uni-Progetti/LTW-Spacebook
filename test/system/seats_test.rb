...
class SeatsTest < ApplicationSystemTestCase
  ...
  test "should create seat" do
    ...
    fill_in "Dep name", with: @seat.dep_name
    fill_in "End date", with: @seat.end_date
    fill_in "Position", with: @seat.position
    fill_in "Space", with: @seat.space_id
    fill_in "Space name", with: @seat.space_name
    fill_in "Start date", with: @seat.start_date
    fill_in "State", with: @seat.state
    fill_in "Typology", with: @seat.typology
